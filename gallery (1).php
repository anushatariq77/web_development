...
<div class="sam" style="background-color: blue; position: absolute;">		
...
<div class="contain" style="margin-left: 40px; margin-top:20px; ">
<img id="myImg" src="Sweptail 6.7 M.T black.jpg" alt="Snow" name="myModal" onclick="mod(this);">
<div id="myModal" class="modal">
<span class="close">&times;</span>
<img class="modal-content" id="img04" src="Sweptail 6.7 M.T black.jpg"">
</div>
<div class="overlay">
<div class="tex">Hello World</div>
</div>
...
<img id="myImg" src="swift 1.3 M.T red.jpg" alt="Snow" name="myModal" onclick="mod(this);">
<div id="myModal" class="modal">
<span class="close">&times;</span>
<img class="modal-content" id="img05" src="swift 1.3 M.T red.jpg"\>
</div>
<div class="overlay">
<div class="tex">Hello World</div>
</div>
...
<img id="myImg" src="patrol 4.0 A.T gray.jpg" alt="Snow" name="myModal" onclick="mod(this);">
<div id="myModal" class="modal">
<span class="close">&times;</span>
<img class="modal-content" id="img09" src="patrol 4.0 A.T gray.jpg">
</div>
<div class="overlay">
<div class="tex">Hello World</div>
</div>
...
<img id="myImg" src="Impala 2.2 A.T blue.jpg" alt="Snow" name="myModal" onclick="mod(this);">
<div id="myModal" class="modal">
<span class="close">&times;</span>
<img class="modal-content" id="img10" src="Impala 2.2 A.T blue.jpg">
</div>
<div class="overlay">
<div class="tex">Hello World</div>
</div>
...
<div class="contain" style=" margin-top: 20px; margin-left: 620px;">
<img id="myImg" src="Ghost 6.5 M.T red.jpg" alt="Snow" name="myModal" onclick="mod(this);">
<div id="myModal" class="modal">
<span class="close">&times;</span>
<img class="modal-content" id="img11" src="Ghost 6.5 M.T red.jpg">
</div>
<div class="overlay">
<div class="tex">Hello World</div>
</div>
...
<div id="myModal" class="modal">
<span class="close">&times;</span>
<span class="modal-content" id="img12" src="R8 4.0 A.T black">  
</div>
<div class="overlay">
