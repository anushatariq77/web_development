	 ...
	 <nav class="sign">
		<img class="logo" src="Capture.png">
			<ul style="margin-left: 900px; margin-top: -100px;">		
				...
				<li class="bounce"><button><a href="admin_verification.php"><i class="fa fa-lock" aria-hidden="true" style="color: black; font-size: 30px; position: absolute; margin-top:10px; margin-left: -12px;"></i></a></button></li>
