...
mysqli_close($con);
 ...
 <table  class="table" style="background: rgb(214, 129, 2,0.8); height:90%; width: 80%; margin-left: 10%; color:black; position: absolute; ">
     <tr>
     ...
     for($i=1;$i<=$num;$i++)
     {
          ...
          ?>
           <tr>
               ...
               <td><button name="car" value="<?php echo $row['cid']; ?>" >UPDATE</button></td>
          </tr> <?php }
 ...
 <br/>
 <!--<input type="submit" value="Update" style="margin-top: 60%; height: 40%; margin-left: 36%; margin-bottom: 5%;width: 20%; font-size: 3em; height: 40%; background-color: black; opacity: 0.7; color: white;">-->
</form>
 </body>
 </html>