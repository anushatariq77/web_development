...
if ($secondChoice=='red' || 'gray' || 'black' || 'white' || 'purple' || 'blue' || 'maroon' || 'green' || 'yellow' )
...
<div style="width: 360px; height: 180px; color: white; margin-left: 320px; padding: 10px; margin-top: -180px;  position: absolute;">
    <p style="margin-left: 15px; font-size: 18px; text-shadow: grey 0 0 10px;margin-top: 10px;"><b>CAR NAME: <?php echo $row['cname'] ?> </b></p>
        <p style="margin-top: -10px; margin-left: 15px; font-size: 15px; text-decoration:underline; margin-top: 10px;">CAR MODEL: <?php echo $row['model']; ?><br/> COLOR: <?php echo $x; ?> </p>
