...
<form action="new.php" method="post">
        <button style="color:white; background-color: black; " class="b1" name='carid' value="<?php echo $row['cid']; ?>" >
                <i class="fa fa-shopping-cart" style="margin-right: 10px" aria-hidden="true" ></i>Order Now </button>
        </div> 
...
<a href="tree.php"><img src="bb (1).png" style="width: 100px; margin-left: 30px; margin-top: 240px; position: absolute;"></a>
